    ...
    return (
        <Fragment>
            ...
            <div className="blog-container">
                ...
                <div className="blog-footer">
                    {/* <ul>
                        ...
                        <li className="comments"><a href="#"><svg className="icon-bubble">
                            <use xlink:href="#icon-bubble"></use>
                        </svg><span className="numero">4</span></a></li>
                        <li className="shares"><a href="#"><svg className="icon-star">
                            <use xlink:href="#icon-star"></use>
                        </svg><span className="numero">1</span></a></li>
                    </ul> */}
                </div>
            ...
            {/* <div className="blog-container">
                ...
                <div className="blog-footer">
                    <ul>
                        ...
                        <li className="comments"><a href="#"><svg className="icon-bubble">
                            <use xlink:href="#icon-bubble"></use>
                        </svg><span className="numero">8</span></a></li>
                        <li className="shares"><a href="#"><svg className="icon-star">
                            <use xlink:href="#icon-star"></use>
                        </svg><span className="numero">3</span></a></li>
                    </ul>
                </div>
            ...
            {/* <div className="blog-container">
                ...
                <div className="blog-body">
                    <video className="video-body" controls poster="http://artbees.net/themes/jupiter-demo/wp-content/uploads/2013/10/home-vid-img.jpg" id="bgvid">
                        ...
                        <div className="blog-footer">
                            <ul>
                                <li className="published-date">1 month ago</li>
                                <li className="comments"><a href="#"><svg className="icon-bubble">
                                    <use xlink:href="#icon-bubble"></use>
                                </svg><span className="numero">12</span></a></li>
                                <li className="shares"><a href="#"><svg className="icon-star">
                                    <use xlink:href="#icon-star"></use>
                                </svg><span className="numero">6</span></a></li>
                            </ul>
                        </div>
